  ...
  return (
    <>
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-[11.5rem] right-4 w-[calc(100vw-2rem)] md:w-[400px] h-[calc(100vh-13.5rem)] max-h-[500px] bg-card border border-border rounded-2xl shadow-2xl flex flex-col z-[60] overflow-hidden"
      ...
      <motion.button
        ...
        className="fixed bottom-32 right-4 w-14 h-14 rounded-full bg-gradient-to-r from-violet-600 to-purple-600 text-white shadow-lg hover:shadow-xl flex items-center justify-center z-[60] transition-shadow"
