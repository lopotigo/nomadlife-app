      ...
      <div className="min-h-screen bg-background">
        <div className="max-w-6xl mx-auto p-4 space-y-6">
          <header className="flex flex-col gap-4">
            <h1 className="text-3xl font-black text-foreground">Explore & Book</h1>
            ...
            <>
              ...
              <AnimatePresence>
                {showFilters && (
                  ...
                  >
                    <div>
                      <label className="text-xs font-bold text-muted-foreground uppercase mb-2 block">Amenities</label>
                    ...
                    <div>
                      <label className="text-xs font-bold text-muted-foreground uppercase mb-2 block">Price Range: ${priceRange[0]} - ${priceRange[1]}</label>
                      <input
                        type="range"
                        min="0"
                        max="500"
                ...
                {places.length === 0 ? (
                  ...
                  places.map((place) => (
                    ...
                    >
                      ...
                      <div className="p-4">
                        <h3 className="font-bold text-lg text-foreground" data-testid={`text-place-name-${place.id}`}>{place.name}</h3>
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex justify-between items-center mt-4 pt-4 border-t border-border">
                          <div className="text-sm">
                            ...
                            {event.capacity && <span className="text-muted-foreground ml-2">{event.attendees}/{event.capacity} spots</span>}
                          </div>
                          <Button
                            size="sm"
                ...
                <div className="p-6 overflow-y-auto flex-1">
                  ...
                  {step === 3 && (
                    <div className="py-12 text-center">
                      ...
                      <h3 className="text-xl font-bold text-foreground mt-4">Booking Confirmed!</h3>
                      <p className="text-muted-foreground mt-2">Your reservation at {selectedPlace.name} is confirmed.</p>
