...
- **Privacy Policy & GDPR**: Full GDPR-compliant privacy policy page at `/privacy-policy`. Signup form requires checkbox acceptance of privacy policy before account creation. Covers data collection, AI usage (OpenAI), third-party sharing, user rights, cookie policy, and data retention. Page: `client/src/pages/privacy-policy.tsx`.
